import CardProduct from "@/components/ecommerce/card/CardProduct";
      ...
      <section className="grid gap-4 grid-cols-1 md:grid-cols-2   ">
        ...
        <div className="flex  flex-col justify-center items-center md:items-start space-y-4 text-black dark:text-white">
          ...
          <h1 className="text-3xl md:text-4xl font-medium ">
            Estilo único, calidad excepcional
          </h1>

          <p className="text-zinc-500 dark:text-zinc-400 text-center">
            Descubre la elegancia y el estilo que te hacen única, solo en Rous
            Boutique.
          </p>

          <button className="bg-green-500 rounded-md px-4 py-2 hover:bg-green-600 flex items-center gap-2 text-white">
            <svg
