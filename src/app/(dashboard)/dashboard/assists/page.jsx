// components/dashboard/common/CreateAssists.jsx
"use client";
...
function CreateAssists() {
  ...
  async function onSubmit(data) {
    ...
    try {
      const result = await axios.post("/api/dashboard/assits", data);
      setSuccessMessage("Hora de ingreso registrado correctamente");
    } catch (err) {
  ...
  <h1 className="text-2xl text-black dark:text-white font-medium">
    Asistencia {new Date().toLocaleDateString('es-ES', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
  </h1>
</div>
