function Footer() {
    return (
      <footer className="bg-white dark:bg-black border-t border-zinc-700 h-16 shadow-md w-full flex flex-col md:flex-row items-center justify-between px-4 md:px-20 py-4 ">
